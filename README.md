...
At a high level, 4 arcade buttons and 4 LED light strings are connected to a Raspberry Pi which activates and blink the LED lights and updates a Google sheet to record which candy was selected and when it was selected.
